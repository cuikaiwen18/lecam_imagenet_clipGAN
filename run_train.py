...
def run(config, ema_losses):
    ...
    text = clip.tokenize(["a airplane", "a automobile", "a bird", "a cat", "a deer", "a dog", "a frog", "a horse", "a ship", "a truck"]).to(device)
    ...
    if config['which_train_fn'] == 'GAN':
        train = train_fns.GAN_training_function(G, D, GD, CLIP, text_feat, z_, y_, ema,
